...
- [ ] **#23 — DB-driven schedule + enable/disable, replacing commented-out code**
...
- [ ] **#26 — Configurable circuit breakers**
  ...
  Build: tunable rules (e.g. "pause entries after N consecutive losing weeks," "skip entry if spot gapped >X% overnight," "halt at -Y% daily drawdown").
