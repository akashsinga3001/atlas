...
def run_daily_account_snapshot(self) -> dict:
    ...
    try:
        ...
        return { "success": True, "message": "ACCOUNT_SNAPSHOT_RECORDED", "data": { "snapshot_date": str(snapshot.snapshot_date), "cash_balance": float(snapshot.cash_balance), "holdings_value": float(snapshot.holdings_value), "total_value": float(snapshot.total_value), }, }
