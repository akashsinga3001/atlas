...
class StrategyService:
    ...
    async def run(self, strategy_version_id: int, as_of_date: Optional[datetime] = None):
        ...
        strategy_class = StrategyRegistry.get_strategy(strategy_version.implementation_class)
