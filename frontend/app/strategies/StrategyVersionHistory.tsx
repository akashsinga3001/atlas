...
function VersionRow({ strategy, version, currentActive }: { strategy: Strategy; version: StrategyVersion; currentActive?: StrategyVersion }) {
    ...
    return (
        <div className="rounded-[var(--radius-card)] p-4 flex flex-col gap-2 bg-surface2 border border-border">
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4" onClick={onClose}>
            ...
            <motion.div
                ...
                className="relative w-full max-w-xl max-h-[85vh] overflow-y-auto rounded-[var(--radius-card)] p-6 flex flex-col gap-4 bg-surface border border-border"
